...
async function main() {
  ...
  const adminExists = await prisma.user.findUnique({
    where: { email: 'bruno_mn@outlook.com' }
  })

  if (!adminExists) {
    const adminPassword = await bcrypt.hash('Bmn.61906190#', 10)
    await prisma.user.create({
      data: {
        email: 'bruno_mn@outlook.com',
        name: 'Bruno Monteiro',
    ...
    console.log('✅ Admin criado: bruno_mn@outlook.com')
  } else {
  ...
  const produtos = [
    {
      name: 'Noir Élégance',
      description: 'Uma fragrância sofisticada e misteriosa, perfeita para ocasiões especiais.',
      image: 'https://images.unsplash.com/photo-1541643600914-78b084683601?w=800',
      size: '100ml',
      concentration: 'EDP',
      price: 299.90,
      stock: 15,
      notes: 'Notas de topo: Bergamota, Limão. Notas de coração: Jasmim, Rosa. Notas de fundo: Âmbar, Cedro',
      intensity: 'Intensa',
      durability: '8-10 horas',
    },
    {
      name: 'Ambre Royale',
      description: 'Luxuoso e envolvente, transmite elegância e poder.',
    ...
    {
      name: 'Velvet Rose',
      description: 'Romântico e sensual, celebra a rosa em sua forma mais pura.',
    ...
    {
      name: 'Oud Mystique',
      description: 'Oriental e rico, apresenta o precioso Oud em toda sua glória.',
    ...
    {
      name: 'Citrus Fresh',
      description: 'Vibrante e energizante, perfeito para o dia a dia.',
      image: 'https://images.unsplash.com/photo-1585120040359-4df1cd89c559?w=800',
      size: '100ml',
      concentration: 'EDT',
      price: 249.90,
      stock: 25,
      notes: 'Notas de topo: Limão, Laranja, Toranja. Notas de coração: Verbena, Chá Verde. Notas de fundo: Almíscar Branco',
      intensity: 'Leve',
      durability: '4-6 horas',
    },
    {
      name: 'Leather & Wood',
      description: 'Masculino e marcante, une couro e madeiras nobres.',
    ...
    {
      name: 'Ocean Breeze',
      description: 'Aquático e refrescante, evoca a brisa do mar.',
  ...
  await prisma.alcohol.create({
    data: { name: 'Álcool de Cereais 96°', quantityLiters: 10, cost: 15.0 },
  })
  ...
  console.log('   Email: bruno_mn@outlook.com')
  console.log('   Senha: Bmn.61906190#')
  console.log('')
}
